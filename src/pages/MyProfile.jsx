...
const MyProfile = () => {
  ...
  return userData && (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      {
        isEdit
          ? <input className='bg-gray text-3xl font-medium max-w-60 mt-4 ' type="text" value={userData.name} onChange={e => setUserData(prev => ({ ...prev, name: e.target.value }))} />
      ...
      <div className='mt-10'>
        {
          isEdit
          ? <button className='border border-primary px-8 py-2 rounded-full' onClick={updateUserProfileData}>Save Information</button>
